...
namespace PokemonJGP
{
    ...
    /// </summary>
    public sealed partial class MisPokemons : Page
    {
        public MisPokemons()
        {
        ...
        private void UcRatingText_VisibleBoundsChanged(ApplicationView sender, object args)
        {
            ...
            if (Width >= 900)
            {
                ...
                RelativePanel.SetRightOf(tbNombre, miGrookey);
                RelativePanel.SetRightOf(tbCategoria, miGrookey);
                RelativePanel.SetRightOf(tbDesc, miGrookey);
            ...
            else
            {
                ...
                RelativePanel.SetBelow(tbNombre, miGrookey);
                RelativePanel.SetBelow(tbCategoria, tbNombre);
                RelativePanel.SetBelow(tbDesc, tbCategoria);
            }
        }
